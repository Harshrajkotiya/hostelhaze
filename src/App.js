    ...
    <Router>
      <ScrollToTop>
        <Switch>
          ...
          <Route exact path={"/lostfound"} component={LostFound} />
          <Route exact path={"/newlostfound"} component={NewLostFound} />
          <Route exact path={"/lostfounditem"} component={LostFoundItem} />
          ...
          <Route exact path={"/complainboxitem"} component={ComplainboxItem} />
